...
import { cinderWake } from '../ring-spells/cinder-wake.js';
import { daggerDisarm } from './dagger-disarm.js';
import { daggerSetTrap } from './dagger-set-trap.js';
import { ember } from '../ring-spells/ember.js';
import { heatSurge } from '../ring-spells/heat-surge.js';
...
const items: [string, AbilityDefinition][] = [
  [axeCleave.id, axeCleave],
  [axeExecute.id, axeExecute],
  [bladeBleed.id, bladeBleed],
