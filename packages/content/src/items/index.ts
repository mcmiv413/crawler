...
export {
  ...
  wardenHelm, ironCrown, mindVeil, swiftBoots, phaseSteps, gripGauntlets, leechWraps, venomRing, blessedRing, ironBand, emberRing, shadowRing, fireRing, lightningRing,
} from './armor/index.js';
export {
