...
export function executeRetreat(state, rng) {
    let events = [];
    events = [...events, {
            type: 'RUN_ENDED',
    ...
    const simulatedEnemies = preSimulateAmbientBehavior(new Map(state.run.enemies), AMBIENT_PROFILES, 5, // Simulate 5 turns while in town
