...
import type { AbilityContext, ConditionalEffect, AbilityCondition } from '../types.js';
...
function evaluateCondition(_context: AbilityContext, condition: AbilityCondition, priorHit: boolean, target?: EnemyInstance): boolean {
